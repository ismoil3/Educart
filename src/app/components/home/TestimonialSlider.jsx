...
const testimonials = [
  {
    ...
    author: {
      ...
      role: "Web Designer",
      image: "https://demoapus1.com/educrat/learnpress/wp-content/uploads/2022/07/test1-2.png"
    }
  },
  {
    category: "Great Work",
  ...
  },
  {
    ...
    author: {
      ...
      image: "https://demoapus1.com/educrat/learnpress/wp-content/uploads/2022/07/test1-1.png"
    }
  },
  {
    category: "Great Work",
...
export function TestimonialSlider() {
  ...
  return (
    <section className={`${isDarkMode ? 'bg-gray-900' : 'bg-[#6440fb]'} px-4 py-20 transition-colors duration-200`}>
          ...
          <Slider ref={sliderRef} {...settings} className="testimonial-slider">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="px-3">
                ...
                >
                  <div className={`mb-4 text-lg font-semibold ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`}>
                    {testimonial.category}
                  </div>
                  <Quote className={`absolute right-8 top-8 h-8 w-8 ${isDarkMode ? 'text-gray-700' : 'text-purple-100'}`} />
